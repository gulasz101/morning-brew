...
Yesterday's hoard: 47 bookmarks — 9 videos (transcribed) and 38 articles. Mostly LinuxLinks roundups and a pile of Open-source Projects GitHub stubs, plus a few YouTube bangers. Here's the lot.

## 1. Cap – lightweight privacy-focused CAPTCHA — by LinuxLinks
...
## 2. Moodist – ambient sounds for focus and calm — by LinuxLinks
...
## 3. One-stop C#/.NET learning hub for tutorials, interviews, and career growth — by Open-source Projects
...
This one's a dead link — the opensourceprojects.dev post now returns a 404, so there's no body to summarize. It was a thin GitHub stub to begin with. Skip it unless you're desperate for C# interview prep.

## 4. OpenCV: the open source computer vision library with docs, forums, and contribution guidelines — by Open-source Projects
...
Another 404 — the post is gone, so there's nothing real to read. It was just a stub pointing at OpenCV's docs and forums anyway. You already know what OpenCV is; move along.

## 5. Single-header OpenType shaping and Unicode segmentation for C/C++ — by Open-source Projects
...
## 6. QAnything 2.0 merges old Docker and Python versions into one Docker Compose command — by Open-source Projects
...
## 7. Statically recompile N64 binaries into portable C with this tool — by Open-source Projects
...
## 8. 100 lines of Python still scores 74% on SWE-bench verified — by Open-source Projects
...
Dead link — the post 404s now. Whatever the 100-line Python trick was, it's gone. Keep the link in case it comes back.

## 9. Markdown resumes that render cleanly in Typora, VSCode, and Obsidian — by Open-source Projects
...
## 10. Build and run agents your team can chat with, in the open — by Open-source Projects
...
## 11. Header-only C++ libraries, organized from argument parsers to web frameworks — by Open-source Projects
...
## 12. ArtCraft is the open-source IDE for interactive AI image and video creation — by Open-source Projects
...
## 13. Peergos: a p2p encrypted filesystem that puts users in control of their data — by Open-source Projects
...
## 14. Curated Swift agent skills for Claude Code, Codex, and more — by Open-source Projects
...
## 15. Campfire: a self-hosted chat app with Docker images and guided deployment — by Open-source Projects
...
## 16. direct multi-scan registration on factor graphs for any range sensor — by Open-source Projects
...
## 17. WayVR brings your Wayland desktop into VR with minimal performance impact — by Open-source Projects
...
## 18. Run IB Gateway and TWS in Docker with zero human interaction — by Open-source Projects
...
## 19. Simple.css: a CSS template for a good looking website, really quick — by Open-source Projects
...
## 20. Building GLaDOS from Portal as a proactive voice assistant with vision and MCP tools — by Open-source Projects
...
## 21. Mimic native iOS system notifications in SwiftUI with a simple view modifier — by Open-source Projects
...
## 22. Nginx RTMP Docker image for streaming from OBS to multiple clients at once — by Open-source Projects
...
## 23. Reverse-engineering cheap Amazon drones to replace their closed-source mobile apps — by Open-source Projects
...
## 24. Calibrate your Monitor with these Open Source Tools — by LinuxLinks
...
## 25. Serf – decentralized service discovery and orchestration — by LinuxLinks
...
## 26. 11 Best Free and Open Source Linux Crafting Tools — by LinuxLinks
...
## 27. openSUSE MicroOS – immutable rolling-release Linux distribution — by LinuxLinks
...
## 28. Apple Will Dominate AI — by Better Stack
...
## 29. mCaptcha – privacy-respecting proof-of-work CAPTCHA — by LinuxLinks
...
## 30. Mintstick – create and format USB sticks — by LinuxLinks
...
## 31. 6 Best Free and Open Source Linux Web-Based Discord Tools — by LinuxLinks
...
## 32. Best Free and Open Source Alternatives to Microsoft Internet Information Services — by LinuxLinks
...
## 33. Latexmk – fully automated LaTeX document generation — by LinuxLinks
...
## 34. TeamMapper – Collaborative Mind Mapping Web App — by LinuxLinks
...
## 35. WyrmRSS – RSS and Atom feed reader — by LinuxLinks
...
## 36. The Arch Linux Malware Is Getting Creative — by Brodie Robertson
...
## 37. Did OpenAI actually build AGI? GPT-6 Astra first look — by Fireship
...
## 38. 3AM Observability Crash Course (A True Story) — by pouria
...
## 39. Omarchy Can Do WHAT?! 50 Features You're Missing — by NetworkChuck
...
## 40. From COBOL to Copilots: Why No-Code Never Kills the Coder - Sam Bishop (PyCon AU 2026) — by PyCon AU
...
## 41. How to Make PERFECT Moka Pot Coffee (Better Than 90% of People!) — by Dero_De_Barista
...
## 42. 10 Best Free and Open Source Linux FTP Servers — by LinuxLinks
...
## 43. Can You Build A MacBook Using Only Aliexpress Parts? — by Phone Repair Guru
...
## 44. Is it time for the Linux TV? — by Haggis on Toast
